...
## option 1: load 2020 Census population, 2019 Census population, 
## and ACS poverty 2019 datasets
...
colnames(Poverty2019)

str(Poverty2019)


## option 2: use tidycensus to get Decennial and ACS data 
...
head(LowPopAsce) ## surprise, NJ is the largest of the "small" states?
